...
class LLMServiceFactory {
    ...
    static func createService() -> LLMService {
        ...
        case .gemini:
            return GeminiService(
                ...
                reasoningModel: .gemini3Pro
            )
        }
    }

    // MARK: - Gemini Advanced Services

    /// Creates a Gemini service optimized for deep philosophical reasoning
    /// Uses Gemini 3 Pro for Consult Marcus enhanced conversations
    static func createGeminiReasoningService() -> GeminiService {
        return GeminiService(
            apiKey: Config.geminiKey,
            model: .gemini25Flash,
            imageModel: .nanoBanana,
    ...
    /// Creates a Gemini service optimized for image generation
    /// Uses Nano Banana Pro for high-quality quote backgrounds
    static func createGeminiImageService() -> GeminiService {
        return GeminiService(
            apiKey: Config.geminiKey,
            model: .gemini25Flash,
    ...
    private static func defaultModel(for provider: LLMProvider) -> LLMModel {
        ...
        case .gemini:
            return .gemini25Flash  // Updated to Gemini 2.5 for better performance
        }
    }
    ...
    static func availableModels(for provider: LLMProvider) -> [LLMModel] {
        ...
        case .gemini:
            return [
                .gemini25Flash,        // Recommended for watchOS
                .gemini3Pro,           // Best reasoning
                .gemini2Flash,         // Legacy fast
                .gemini2Pro,           // Legacy capable
                .gemini1_5Pro,         // Legacy
                .nanoBanana,           // Image generation (fast)
                .nanoBananaPro         // Image generation (quality)
            ]
        }
    }
