...
1. **In Xcode Project Navigator** (left sidebar):
   - Right-click on `Stoic_Camarade Watch App` folder
   - Select **"Add Files to 'Stoic_Camarade'..."**
...
3. **IMPORTANT - Check these options**:
   ...
   - ☑️ "Create groups"
   - ☑️ **Add to targets: "Stoic_Camarade Watch App"** ← CRITICAL!
...
- Select file → File Inspector → Target Membership → Check "Stoic_Camarade Watch App"
